...
class CustomerView(TemplateView):
	template_name = "bnagazon_storefront/customer_view.html"

class LoginView(TemplateView): 
	template_name = "bangazon_storefront/login.html"

class RegisterView(TemplateView):
	template_name = "bangazon_storefront/register.html" 

class LogoutView(TemplateView): 
	template_name = "bangazon_storefront/logout.html" 
